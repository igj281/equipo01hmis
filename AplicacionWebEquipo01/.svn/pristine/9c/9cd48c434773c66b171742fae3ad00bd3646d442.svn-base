    ...
    <body>
        <div class="container">
            ...
            {{ Form::open(array('url' => '/registro', 'class'=>'col-md-6 col-md-offset-3')) }}
                ...
                {{ Form::text('user', null, array('class'=>'form-control','placeholder="Nick de identificacion"')); }}

                {{ Form::label('contraseña', 'Contraseña') }}
                {{ Form::password('password', array('class'=>'form-control','placeholder="contraseña"')); }}

                {{ Form::label('email', 'direccion email') }}
                {{ Form::text('email', null, array('class'=>'form-control','placeholder="loquesea@loquesea.com"')); }}
